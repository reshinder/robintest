...
let sidemain = {
  ...
  return {
    ...
    methods: {
        ...
        registDepth(){
            this.websocket = new WebSocket("ws://106.14.210.142:90/mkapi/ws");
            this.websocket.onopen = function(){
                console.log("websocket open");
                that.websocket.send('[{"type":"subHq","event":"depth","param":{"businessType":"coin-usd-btc"}}]');
            }
            this.websocket.inclose = function(){
              debugger;
