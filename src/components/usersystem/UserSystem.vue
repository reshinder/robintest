      ...
      <div class="row">
        <div class="col-md-2 l-panel">
          <ul>
            ...
            <li class="">Address Book</li>
            <li class="report active"><span>Report</span><span class="arrow down-arrow"></span>
              <ul class="report-list">
                <li class="active">Balance</li>
                <li class="">Order Histrory</li>
                <li class="">Deposit</li>
        ...
        <div class="col-md-10 r-tab">
          <div class="reports-out">
            <div class="report-unit">
              <div class="title">
                <div class="u-out"><span class="u-title">Order History</span> <span class="executed"><span
                  class="mo-choose"></span> <span>(Partially) Executed</span></span></div>
                <div class="sub-right">
                  <div class="right-unit ok">OK</div>
                  <div class="right-unit"><span class="title-c">10.12-11.12</span> <span class="box-arrow"><i
                    class="down_gray_arrow"></i></span></div>
                  <div class="right-unit"><span class="title-c">BTC/USD</span> <span class="box-arrow"><i
                    class="down_gray_arrow"></i></span></div>
                </div>
              </div>
              <div class="table-out">
                <table>
                  ...
                  <tr>
                    ...
                    <td><span>Buy</span></td>
                    <td><span>500.<span class="gy">0000</span></span><span>/</span><span>700.2<span
                      class="gy"></span></span></td>
