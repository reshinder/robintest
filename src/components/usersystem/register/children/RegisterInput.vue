    ...
    <div class="row">
      <form class="register" id="register">
        ...
        <div class='register-box'>
          ...
          <div class="input-wrap">
            <input id="password" class="password" v-model="password"  type="password" name="password" placeholder="Password"  value="" />
      ...
      remoteAction: function (arg) {
        ...
        Axios.get('/user_account.act?cmd=registerByEmail&',{params:paraObj})
          .then(function (response) {
            ...
            //邮件地址注册成功：base_url/register/register_Success
            //邮件地址失效：base_url/register/link_expired
            if(cuData.success){ //成功路由
               self.$router.push({ path: '/register/register_success' })
            }else{
             //  self.$router.push({ path: '/register/register_success' })
            }
